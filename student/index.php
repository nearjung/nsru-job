...
<body>
                    ...
                    <div class="app-main__inner">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">งานทั้งหมด</div>
                                            <div class="widget-subheading">จำนวนงานทั้งหมดที่ยังรับอยู่</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo number_format($api->CountList($member['stu_id'],1)); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">งานตามสายอาชีพ</div>
                                            <div class="widget-subheading">งานทั้งหมดตามสายอาชีพของคุณ</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo number_format($api->CountList($member['stu_id'],2)); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">งานที่สมัคร</div>
                                            <div class="widget-subheading">จำนวนงานที่คุณส่งใบสมัคร</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span><?php echo number_format($api->CountList($member['stu_id'],3)); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
									<?php
									$job_sql = $sql->prepare("SELECT * FROM Annoucement ORDER BY ann_id DESC");
									$job_sql->execute();
  ...
  <tbody>
    <tr>
      ...
      <td width="70%" valign="top"><div style="color=#0a13cd;"><strong><a href="jobinfo.php?id='.$job['ann_id'].'">'.$job['title'].'</a></strong></div></td>';
	?>
    ...
    <tr>
	  ...
	  ';
									?>
      <td rowspan="2" valign="middle" align="center"><a onclick="return confirm('คุณต้องการที่จะส่งไปสมัครหรือไม่ ?')" href="index.php?a=cart&id=<?php echo $job['ann_id']; ?>"><button class="mb-2 mr-2 btn btn-warning">จัดเก็บงาน</button></a></td>
								<?php echo '	
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
